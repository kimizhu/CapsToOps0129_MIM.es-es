---
title: Trabajar con MIM Certificate Manager
ms.custom: 
  - Identity Management
  - MIM
...
6.  Haga clic con el botón derecho en la plantilla **Inicio de sesión de tarjeta inteligente** y haga clic en **Plantilla duplicada**.
...
9. En la pestaña **Tratamiento de la solicitud**, establezca el **Propósito** en **Firma y cifrado** y bajo **Hacer lo siguiente...** seleccione **Preguntar al usuario durante la inscripción**.
...
15. Haga clic con el botón derecho en **Plantillas de certificado**, haga clic en **Nueva &gt; Plantilla de certificado que se va a emitir**.
...
8.  Marque las casillas junto a **Crear/destruir tarjeta inteligente virtual** y **Diversificar clave de administración**.
...
8.  En el elemento &lt;Identity&gt; modifique el valor del atributo Publicador para que sea idéntico al Firmante que aparece en el certificado de firma, como, por ejemplo "CN=FIRMANTE".
