---
title: Obtener respuestas de certificado
ms.custom: 
  - MIM
...
---
# Obtener respuestas de certificado
...
Si se ejecuta correctamente, devuelve una lista de objetos JSON serializados [Microsoft.Clm.Shared.Certificates.Certificate](https://msdn.microsoft.com/es-es/library/microsoft.clm.shared.certificates.certificate(v=vs.100%29.aspx) con las siguientes propiedades:
...
------|-------------
 ...
 UseLocalMachineStore| Valor booleano que indica si el certificado es para el almacén de certificados del equipo local.
## Ejemplo
...
- [Método Microsoft.Clm.Provision.ExecuteOperations.Enroll](https://msdn.microsoft.com/en-us/library/microsoft.clm.provision.executeoperations.enroll.aspx)
